		  ...
		  if (!$ul.hasClass('third-processed')) {
			...
			*/
            ...
            if (!$('body').hasClass('drawer')) {
                ...
                $('.region-navigation').prepend('<a href="#" class="menu-burger" title="Toggle Mobile Menu Navigation"><i class="fa fa-bars" aria-hidden="true"></i><span class="sr-only">Toggle Mobile Menu Navigation</span></a>');
                $('.region-mobile-navigation').addClass('drawer-nav').children('.drawer-wrap').prepend('<a href="#" class="menu-close" title="Toggle Mobile Menu Navigation"><i class="fa fa-times" aria-hidden="true"></i><span class="sr-only">Toggle Mobile Menu Navigation</span></a>');
